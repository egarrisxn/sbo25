...
import QuestionSnippet from "@/app/(pages)/_components/question-snippet";
    ...
    <section className='min-h-screen w-full py-12'>
      <div className='container mx-auto my-24 max-w-2xl px-4 lg:max-w-5xl xl:px-0'>
        <div className='mx-auto grid grid-cols-1 items-center'>
          <h1 className='mb-2 font-serif text-[1.5rem] leading-snug font-bold text-accent-foreground md:mb-4 xl:text-[2.0rem] xl:leading-none'>
            Media Kit
          </h1>
