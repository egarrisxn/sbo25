...
export default function Twitter() {
  return (
    <div className='container mx-auto py-24'>
      <div className='mx-auto grid w-full max-w-screen-lg grid-cols-1 gap-6 px-6 xl:max-w-screen-xl 2xl:max-w-screen-2xl 2xl:px-16'>
        <section className='mx-auto flex w-full flex-col gap-1 lg:gap-3'>
          <BlurText
            delay={0.1}
