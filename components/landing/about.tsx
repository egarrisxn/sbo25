...
export default function About() {
  return (
    <div className='container mx-auto pt-24'>
      <div
        id='about'
        className='mx-auto grid w-full max-w-screen-lg grid-cols-1 gap-12 px-6 md:grid-cols-2 md:gap-6 lg:gap-8 xl:max-w-screen-xl xl:gap-0 2xl:max-w-screen-2xl'
      >
